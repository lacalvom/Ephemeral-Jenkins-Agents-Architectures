...
## JDK del agente vs JDK de compilación

- El **agente** corre sobre el **JDK 21** de la imagen base (coherente con el
  JDK del Jenkins Controller).
- El **build** se compila con **JDK 17** seleccionado por **Maven Toolchains**,
  con independencia del JDK que ejecuta Maven. Ver ADR-0006.
...
pipeline usa `-Dmaven.repo.local=/cache/.m2/repository`.
