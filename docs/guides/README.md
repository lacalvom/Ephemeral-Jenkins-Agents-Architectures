...
2. **[2_Ephemeral-Jenkins-Agents-Podman-host.md](./2_Ephemeral-Jenkins-Agents-Podman-host.md)**
   ...
   Es el modelo del laboratorio `Podman-Host`.
...
El código del repositorio `Ephemeral-Jenkins-Agents-Architectures` usa por separado la licencia
...
- [Architecture Decision Records](../adr/README.md) — decisiones del laboratorio
  `Podman-Host` (incluida la que documenta el modelo Podman-Host).
