...
echo "  - jenkins-controller @ 192.168.122.20"
echo "  - podman-host         @ 192.168.122.21"
echo
...
echo
echo "Jenkins:      http://192.168.122.20:8080  (usuario: admin)"
...
# ssh -i ~/.ssh/id_ed25519 -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null <nombre-usuario>@192.168.122.20
# ssh -i ~/.ssh/id_ed25519 -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null <nombre-usuario>@192.168.122.21
